...
import { configuredMediaUploader } from '../lib/persian-media-upload.mjs';
import { escapeHtml, readLimitedBody } from '../lib/persian-onboarding.mjs';
import { handleApprovalCallback } from '../lib/persian-workflow.mjs';
...
} else console.log('Usage: node scripts/persian-instagram.mjs <serve|daily [--notify]|telegram-poll [--once]|publish-approved>');
